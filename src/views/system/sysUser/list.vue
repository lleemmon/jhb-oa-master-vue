  ...
  <div class="app-container">
    ...
    <el-dialog title="添加/修改" :visible.sync="dialogVisible" width="40%" >
      <el-form ref="dataForm" :model="sysUser"  label-width="100px" size="small" style="padding-right: 40px;">
        <el-form-item label="用户名" proshowAssignRolep="username">
...
<script>
import api from '@/api/system/sysUser/sysUser'
import roleApi from '@/api/system/sysRole/sysRole'
const defaultForm = {
  id: '',
  username: '',
  password: '',
